...
<div class="container py-5 my-4">
        ...
        <div class="p-4 p-md-5 pt-0">
            <div class="d-flex flex-column flex-md-row align-items-center align-items-md-end justify-content-between gap-3" style="margin-top: -60px;">
                <div class="d-flex flex-column flex-md-row align-items-center align-items-md-end gap-3 text-center text-md-start">
                    ...
                    <div class="mb-2">
                        <h3 class="font-heading fw-bold mb-1"><?= e($profileUser['name']) ?></h3>
                ...
                <div class="d-flex gap-2">
                    <?php if ($isOwnProfile): ?>
                        <a href="<?= BASE_URL ?>/pages/edit_profile.php" class="btn-ciy-outline btn-sm"><i class="fa-solid fa-pen me-1"></i> Edit Profile</a>
                    <?php elseif ($currentUserId): ?>
                        <button class="btn-ciy-primary btn-sm px-4" onclick="toggleFollowUser(<?= $profileUser['id'] ?>)">
                            <span id="profileFollowText"><?= $isFollowing ? 'Following' : 'Follow Creator' ?></span>
                        </button>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <?php if (!empty($profileUser['bio'])): ?>
                <p class="text-muted mb-0 small text-center text-md-start"><?= e($profileUser['bio']) ?></p>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <h4 class="font-heading fw-bold mb-0">Uploaded Recipes</h4>
        <?php if ($isOwnProfile): ?>
            <a href="<?= BASE_URL ?>/pages/upload.php" class="btn-ciy-primary btn-sm"><i class="fa-solid fa-plus me-1"></i> Create New</a>
        <?php endif; ?>
    </div>
    ...
    <?php else: ?>
        <div class="glass-card text-center py-5">
            ...
            <h5 class="font-heading fw-bold">No Recipes Uploaded Yet</h5>
            <p class="text-muted small">This creator hasn't published any recipes yet.</p>
        </div>
    <?php endif; ?>
</div>
