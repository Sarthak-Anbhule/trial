...
<div class="container py-5 my-4">
    <div class="text-center mb-5">
        <h2 class="font-heading fw-bold display-5 mb-2"><?= t('browse_categories') ?></h2>
        <p class="text-muted"><?= t('browse_categories_subtitle') ?></p>
    </div>
        ...
        <?php foreach ($categories as $cat): ?>
            <div class="col-md-4 col-lg-3">
                <a href="<?= BASE_URL ?>/pages/explore.php?category=<?= e($cat['slug']) ?>" class="glass-card text-center p-4 d-block text-reset h-100" data-aos="fade-up">
                    ...
                    <h5 class="font-heading fw-bold mb-1"><?= t(slugify($cat['name']), e($cat['name'])) ?></h5>
                    <p class="text-muted small mb-2"><?= t_content(e($cat['description'])) ?></p>
