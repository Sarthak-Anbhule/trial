...
$ciy_translations = [
    ...
    'hi' => [
        ...
        // Ingredients & Steps Full Coverage (Hindi)
        'Fettuccine Pasta' => 'फेटुकाइन पास्ता',
        'Boneless Chicken Breast (Diced)' => 'बोनलेस चिकन ब्रेस्ट (कटा हुआ)',
        'Heavy Cream & Butter' => 'हैवी क्रीम और मक्खन',
        'Grated Parmesan Cheese' => 'कद्दूकस किया हुआ परमेसन चीज़',
        'Minced Garlic & Italian Herbs' => 'बारीक कटा लहसुन और इटैलियन जड़ी-बूटियाँ',
        'Tipo 00 Pizza Flour' => 'पिज्जा आटा (मैदा)',
        'San Marzano Tomato Sauce' => 'इटैलियन टमाटर सॉस',
        'Fresh Mozzarella Di Bufala' => 'ताज़ा मोज़ेरेला चीज़',
        'Fresh Sweet Basil' => 'तुलसी की पत्तियाँ (बेसिल)',
        'Extra Virgin Olive Oil' => 'जैतून का तेल',
        'Ground Beef (80/20)' => 'कीमा बीफ / चिकन',
        'Lasagna Pasta Sheets' => 'लसग्ना पास्ता शीट्स',
        'Ricotta & Mozzarella Cheese' => 'रिकोटा और मोज़ेरेला चीज़',
        'Bolognese Tomato Sauce' => 'बोलोनेज़ टमाटर सॉस',
        'Béchamel Sauce' => 'बेशामेल सॉस',
        'Arborio Rice' => 'आरबोरियो राइस',
        'Sliced Wild Mushrooms' => 'कटे हुए जंगली मशरूम',
        'Warm Vegetable Broth' => 'सब्जी का शोरबा (स्टॉक)',
        'Dry White Wine' => 'ड्राई व्हाइट वाइन / विनेगर',
        'Grated Parmesan & Butter' => 'कद्दूकस परमेसन और मक्खन',
        'Spaghetti Pasta' => 'स्पैगेटी पास्ता',
        'Crispy Guanciale or Pancetta' => 'क्रिस्पी चिकन / पोर्क स्ट्रिप्स',
        'Egg Yolks' => 'अंडे की ज़र्दी (योक)',
        'Pecorino Romano Cheese' => 'पेकोरिनो रोमानो चीज़',
        'Coarsely Ground Black Pepper' => 'पिसी हुई काली मिर्च',
        'Chicken Pieces' => 'चिकन के टुकड़े',
        'Aromatic Aged Basmati Rice' => 'सुगंधित बासमती चावल',
        'Fried Crispy Onions (Birista)' => 'तली हुई कुरकुरी प्याज (बिरिस्ता)',
        'Yogurt, Mint & Saffron Milk' => 'दही, पुदीना और केसर का दूध',
        'Pure Desi Ghee & Biryani Spices' => 'शुद्ध देसी घी और बिरयानी मसाले',
        'Soaked White Chickpeas (Kabuli Chana)' => 'भिगोए हुए सफेद काबुली चने',
        'Onions & Tomato Paste' => 'प्याज और टमाटर का पेस्ट',
        'Amritsari Chole Masala' => 'अमृतसरी छोले मसाला',
        'All Purpose Flour (Maida) for Bhatura' => 'भटूरे का मैदा',
        'Yogurt & Cooking Oil' => 'दही और तेल',
        'Fermented Rice & Urad Dal Batter' => 'डोसा बटर (चावल उड़द दाल घोल)',
        'Boiled Potatoes (Mashed)' => 'उबले हुए आलू (मैश किए)',
        'Sliced Onion & Green Chilies' => 'कटी प्याज और हरी मिर्च',
        'Mustard Seeds & Curry Leaves' => 'राई और कढ़ी पत्ता',
        'Fresh Coconut Chutney' => 'ताज़ा नारियल की चटनी',
        'Primary Fresh Protein / Vegetable' => 'ताज़ा प्रोटीन / सब्जियाँ',
        'Chef Spices & Seasoning Mixture' => 'शेफ विशेष मसाले',
        'Signature Flavoring Sauce & Garnish' => 'विशेष सॉस और गार्निश',

        'Boil Fettuccine Pasta' => 'फेटुकाइन पास्ता उबालें',
        'Boil pasta in salted water for 8-10 minutes until al dente. Drain and reserve pasta water.' => 'नमकीन पानी में पास्ता 8-10 मिनट उबालें। पानी छान लें और थोड़ा पानी बचा कर रखें।',
        'Sear Seasoned Chicken' => 'चिकन को भूनें',
        'Pan sear diced chicken breast in olive oil with salt and black pepper until golden brown.' => 'जैतून के तेल में नमक और काली मिर्च के साथ चिकन को सुनहरा होने तक भूनें।',
        'Simmer Garlic Cream Sauce' => 'लहसुन क्रीम सॉस बनाएं',
        'Melt butter, sauté minced garlic, pour in heavy cream and stir in parmesan cheese until velvety smooth.' => 'मक्खन पिघलाएं, बारीक कटा लहसुन भूनें, हैवी क्रीम और चीज़ मिलाकर चिकना सॉस बनाएं।',
        'Stretch Pizza Dough' => 'पिज्जा का आटा फैलाएं',
        'Stretch fermented pizza dough into a 10-inch round disc on a floured surface.' => 'आटे की सतह पर पिज्जा डो को गोल आकार में फैलाएं।',
        'Apply Sauce & Mozzarella' => 'सॉस और मोज़ेरेला लगाएं',
        'Ladle San Marzano tomato sauce evenly over dough and top with fresh mozzarella slices.' => 'टमाटर सॉस फैलाएं और ताज़ा मोज़ेरेला चीज़ रखें।',
        'Wood Fire Bake' => 'ओवन में बेक करें',
        'Bake at 500°F (260°C) for 7-9 minutes until crust is blistered, top with fresh basil leaves.' => '500°F पर 7-9 मिनट बेक करें, ऊपर से ताज़ी तुलसी की पत्तियाँ सजाएं।',
        'Prepare Bolognese Sauce' => 'बोलोनेज़ सॉस बनाएं',
        'Brown ground beef with onions, garlic, and simmer in tomato sauce for 30 minutes.' => 'कीमा को प्याज, लहसुन और टमाटर सॉस के साथ 30 मिनट तक पकाएं।',
        'Layer Lasagna Sheets' => 'लसग्ना की परतें बनाएं',
        'Layer meat sauce, lasagna pasta sheets, creamy béchamel, and mozzarella in baking dish.' => 'बेकिंग डिश में सॉस, लसग्ना शीट, बेशामेल और मोज़ेरेला की परतें बनाएं।',
        'Bake Until Golden' => 'सुनहरा होने तक बेक करें',
        'Bake covered at 375°F (190°C) for 35 minutes, then uncover for 10 minutes until golden bubbly.' => '375°F पर 35 मिनट ढँककर और 10 मिनट खोलकर बेक करें।',
        'Sauté Mushrooms' => 'मशरूम भूनें',
        'Sauté wild mushrooms in butter with shallots and thyme until golden and fragrant.' => 'मक्खन में जंगली मशरूम भूनें जब तक वे सुनहरे और सुगंधित न हो जाएं।',
        'Toast Arborio Rice' => 'आरबोरियो राइस भूनें',
        'Toast arborio rice in pan, deglaze with white wine and stir until absorbed.' => 'पैन में चावल भूनें और धीमी आंच पर पकाएं।',
        'Slowly Add Broth' => 'धीरे-धीरे शोरबा मिलाएं',
        'Ladle warm broth one cup at a time, stirring constantly until rice is creamy and tender.' => 'धीरे-धीरे गर्म शोरबा मिलाएं और चावल के क्रीमी होने तक लगातार चलाएं।',
        'Crisp Guanciale' => 'चिकन / पोर्क भूनें',
        'Fry diced guanciale in skillet over medium heat until crispy and fat is rendered.' => 'पैन में कुरकुरा होने तक भूनें।',
        'Whisk Egg & Cheese Mixture' => 'अंडे और चीज़ का मिश्रण फेटें',
        'Whisk egg yolks with grated pecorino romano and black pepper in a bowl.' => 'कटोरी में अंडे की ज़र्दी, कद्दूकस चीज़ और काली मिर्च फेटें।',
        'Emulsify Pasta Sauce' => 'पास्ता सॉस मिलाएं',
        'Toss hot spaghetti into skillet, remove from heat, quickly stir in egg mixture to create creamy sauce.' => 'गरम स्पैगेटी में अंडे का मिश्रण मिलाकर क्रीमी सॉस बनाएं।',
        'Marinate & Grill Chicken' => 'चिकन मैरीनेट और ग्रिल करें',
        'Marinate chicken in yogurt and spices for 2 hours, then sear until charred.' => 'दही और मसालों में मैरीनेट करें और ग्रिल करें।',
        'Simmer Makhani Gravy' => 'मखनी ग्रेवी पकाएं',
        'Cook tomato puree with butter and spices for 15 minutes until oil separates.' => 'टमाटर प्यूरी को मक्खन और मसालों के साथ 15 मिनट पकाएं।',
        'Combine & Finish with Cream' => 'क्रीम मिलाकर पूरा करें',
        'Add seared chicken to gravy, stir in heavy cream and crushed kasuri methi.' => 'ग्रेवी में चिकन, हैवी क्रीम और कसूरी मेथी मिलाएं।',
        'Blend Cashew Tomato Gravy' => 'काजू टमाटर ग्रेवी बनाएं',
        'Blend soaked cashews with tomatoes into smooth puree. Sauté in butter with spices.' => 'भिगोए काजू और टमाटर पीसकर मक्खन में भूनें।',
        'Simmer Paneer Cubes' => 'पनीर के टुकड़े पकाएं',
        'Add fresh paneer cubes into simmering gravy and cook on low heat for 5 minutes.' => 'ग्रेवी में ताज़ा पनीर के टुकड़े डालकर 5 मिनट पकाएं।',
        'Garnish with Cream' => 'क्रीम से सजाएं',
        'Drizzle heavy cream and sprinkle kasuri methi before serving with garlic naan.' => 'हैवी क्रीम और कसूरी मेथी छिड़क कर परोसें।',
        'Marinate Biryani Chicken' => 'बिरयानी चिकन मैरीनेट करें',
        'Marinate chicken with yogurt, ginger garlic paste, green chilies, mint, and whole biryani spices.' => 'दही, अदरक लहसुन पेस्ट, पुदीना और मसालों के साथ चिकन मैरीनेट करें।',
        'Parboil Basmati Rice' => 'बासमती चावल उबालें',
        'Boil basmati rice with cardamom and cloves until 70% cooked.' => 'इलायची और लौंग के साथ चावल 70% तक उबालें।',
        'Dum Layer & Steam Cook' => 'दम लगाकर पकाएं',
        'Layer marinated chicken and rice in handi, sprinkle saffron ghee, seal lid and dum cook for 25 minutes.' => 'हंडी में चिकन और चावल की परतें बनाकर 25 मिनट दम पर पकाएं।',
        'Pressure Cook Chickpeas' => 'चने कुकर में उबालें',
        'Pressure cook soaked chickpeas with tea bag and bay leaf until buttery soft.' => 'चने सॉफ्ट होने तक कुकर में पकाएं।',
        'Simmer Spicy Chole Gravy' => 'छोले ग्रेवी पकाएं',
        'Sauté onions, ginger, tomato paste, chole masala, and simmer cooked chickpeas.' => 'प्याज, अदरक और छोले मसाले के साथ चने धीमी आंच पर पकाएं।',
        'Fry Puffed Bhaturas' => 'फूले भटूरे तलें',
        'Knead fermented dough, roll discs and deep fry in hot oil until puffed golden.' => 'मैदा गूंधकर गरम तेल में फूले हुए भटूरे तलें।',
        'Prepare Spiced Potato Filling' => 'आलू का मसाला बनाएं',
        'Temper mustard seeds, curry leaves, onions, turmeric, and mix with mashed potatoes.' => 'राई, कढ़ी पत्ता और मसालों के साथ आलू का मसाला तैयार करें।',
        'Spread Crisp Dosa Crepe' => 'कुरकुरा डोसा फैलाएं',
        'Ladle fermented batter onto hot tawa, spread thinly into circle and drizzle oil.' => 'गरम तवे पर घोल डालकर गोल फैलाएं और तेल लगाएं।',
        'Stuff & Roll Dosa' => 'डोसा रोल करें',
        'Place potato mash in center, fold golden crispy dosa and serve with sambar.' => 'बीच में आलू मसाला रखकर डोसा रोल करें और परोसें।',
        'Prep Fresh Ingredients' => 'सामग्री तैयार करें',
        'Wash, chop, and marinate fresh ingredients with seasonings.' => 'सामग्री धोकर काटें और मसालों के साथ मिलाएँ।',
        'Sauté & Cook Medium Heat' => 'धीमी आंच पर पकाएं',
        'Cook ingredients in skillet until fragrant, golden, and cooked through.' => 'सामग्री को सुनहरे और सुगंधित होने तक पकाएं।',
        'Plate & Serve Hot' => 'गरम-गरम परोसें',
        'Transfer to serving plate, garnish with herbs and serve fresh!' => 'प्लेट में निकालें, ताजी जड़ी-बूटियों से सजाएं और गरम परोसें!',
    ...
    'mr' => [
        ...
        // Ingredients & Steps Full Coverage (Marathi)
        'Fettuccine Pasta' => 'फेटुकाइन पास्ता',
        'Boneless Chicken Breast (Diced)' => 'बोनलेस चिकन ब्रेस्ट (तुकडे केलेले)',
        'Heavy Cream & Butter' => 'हेव्ही क्रीम आणि बटर',
        'Grated Parmesan Cheese' => 'किसलेले परमेसन चीज',
        'Minced Garlic & Italian Herbs' => 'बारीक चिरलेला लसूण आणि इटालियन हर्ब्स',
        'Tipo 00 Pizza Flour' => 'पिज्जा पीठ',
        'San Marzano Tomato Sauce' => 'इटालियन टोमॅटो सॉस',
        'Fresh Mozzarella Di Bufala' => 'ताजे मोजरेला चीज',
        'Fresh Sweet Basil' => 'तुळशीची पाने (बेसिल)',
        'Extra Virgin Olive Oil' => 'ऑलिव्ह ऑइल',
        'Ground Beef (80/20)' => 'चिकन / बीफ कीमा',
        'Lasagna Pasta Sheets' => 'लसग्ना पास्ता शीट्स',
        'Ricotta & Mozzarella Cheese' => 'रिकोटा आणि मोजरेला चीज',
        'Bolognese Tomato Sauce' => 'बोलोनेझ टोमॅटो सॉस',
        'Béchamel Sauce' => 'बेशामेल सॉस',
        'Arborio Rice' => 'आरबोरियो राईस',
        'Sliced Wild Mushrooms' => 'चिरलेले मशरूम',
        'Warm Vegetable Broth' => 'भाज्यांचे सूप / स्टॉक',
        'Dry White Wine' => 'व्हाइट वाइन / सिरका',
        'Grated Parmesan & Butter' => 'किसलेले चीज आणि बटर',
        'Spaghetti Pasta' => 'स्पॅगेटी पास्ता',
        'Crispy Guanciale or Pancetta' => 'चिकन / पोर्क स्ट्रिप्स',
        'Egg Yolks' => 'अंड्याचा पिवळा भाग (योक)',
        'Pecorino Romano Cheese' => 'पेकोरिनो रोमानो चीज',
        'Coarsely Ground Black Pepper' => 'काळी मिरी पूड',
        'Chicken Pieces' => 'चिकनचे तुकडे',
        'Aromatic Aged Basmati Rice' => 'सुवासिक बासमती तांदूळ',
        'Fried Crispy Onions (Birista)' => 'तळलेला कांदा (बिरिस्ता)',
        'Yogurt, Mint & Saffron Milk' => 'दही, पुदिना आणि केसराचे दूध',
        'Pure Desi Ghee & Biryani Spices' => 'शुद्ध देशी तूप आणि बिर्याणी मसाले',
        'Soaked White Chickpeas (Kabuli Chana)' => 'भिजवलेले पांढरे काबुली चणे',
        'Onions & Tomato Paste' => 'कांदा आणि टोमॅटो पेस्ट',
        'Amritsari Chole Masala' => 'अमृतसरी छोले मसाला',
        'All Purpose Flour (Maida) for Bhatura' => 'भटुऱ्याचे मैदा',
        'Yogurt & Cooking Oil' => 'दही आणि तेल',
        'Fermented Rice & Urad Dal Batter' => 'डोसा पीठ (तांदूळ उडीद डाळ),',
        'Boiled Potatoes (Mashed)' => 'उकडलेले बटाटे (मॅश केलेले)',
        'Sliced Onion & Green Chilies' => 'चिरलेला कांदा आणि हिरवी मिरची',
        'Mustard Seeds & Curry Leaves' => 'मोहरी आणि कढीपत्ता',
        'Fresh Coconut Chutney' => 'ताजी नारळाची चटणी',
        'Primary Fresh Protein / Vegetable' => 'ताजे साहित्य व भाज्या',
        'Chef Spices & Seasoning Mixture' => 'खास मसाले',
        'Signature Flavoring Sauce & Garnish' => 'खास सॉस आणि गार्निश',

        'Boil Fettuccine Pasta' => 'पास्ता उकळवा',
        'Boil pasta in salted water for 8-10 minutes until al dente. Drain and reserve pasta water.' => 'मीठ टाकून पाण्यात पास्ता ८-१० मिनिटे उकळवा. पाणी गाळून बाजूला ठेवा.',
        'Sear Seasoned Chicken' => 'चिकन परतावून घ्या',
        'Pan sear diced chicken breast in olive oil with salt and black pepper until golden brown.' => 'ऑलिव्ह ऑइलमध्ये मीठ आणि काळी मिरी लावून चिकन सोनेरी रंगावर परता.',
        'Simmer Garlic Cream Sauce' => 'लसूण क्रीम सॉस बनवा',
        'Melt butter, sauté minced garlic, pour in heavy cream and stir in parmesan cheese until velvety smooth.' => 'बटर वितळवून लसूण परता, क्रीम आणि चीज घालून सॉस बनवा.',
        'Stretch Pizza Dough' => 'पिज्जा पीठ पसरवा',
        'Stretch fermented pizza dough into a 10-inch round disc on a floured surface.' => 'पिज्जा पीठ गोल आकारात पसरवून घ्या.',
        'Apply Sauce & Mozzarella' => 'सॉस आणि चीज लावा',
        'Ladle San Marzano tomato sauce evenly over dough and top with fresh mozzarella slices.' => 'टोमॅटो सॉस पसरवून त्यावर मोजरेला चीज ठेवा.',
        'Wood Fire Bake' => 'बेक करा',
        'Bake at 500°F (260°C) for 7-9 minutes until crust is blistered, top with fresh basil leaves.' => '५००°F वर ७-९ मिनिटे बेक करा आणि तुळशीची पाने ठेवा.',
        'Prepare Bolognese Sauce' => 'बोलोनेझ सॉस बनवा',
        'Brown ground beef with onions, garlic, and simmer in tomato sauce for 30 minutes.' => 'कीमा कांदा, लसूण आणि टोमॅटो सॉससोबत ३० मिनिटे शिजवा.',
        'Layer Lasagna Sheets' => 'लसग्ना थर लावा',
        'Layer meat sauce, lasagna pasta sheets, creamy béchamel, and mozzarella in baking dish.' => 'बेकिंग डिशमध्ये सॉस, लसग्ना शीट आणि चीजचे थर लावा.',
        'Bake Until Golden' => 'सोनेरी होईपर्यंत बेक करा',
        'Bake covered at 375°F (190°C) for 35 minutes, then uncover for 10 minutes until golden bubbly.' => '३७५°F वर ३५ मिनिटे झाकून बेक करा.',
        'Sauté Mushrooms' => 'मशरूम परता',
        'Sauté wild mushrooms in butter with shallots and thyme until golden and fragrant.' => 'बटरमध्ये मशरूम सुवासिक होईपर्यंत परता.',
        'Toast Arborio Rice' => 'तांदूळ परता',
        'Toast arborio rice in pan, deglaze with white wine and stir until absorbed.' => 'पॅनमध्ये तांदूळ परतून मंद आचेवर शिजवा.',
        'Slowly Add Broth' => 'हळूहळू सूप घाला',
        'Ladle warm broth one cup at a time, stirring constantly until rice is creamy and tender.' => 'हळूहळू सूप घालून भात मऊ होईपर्यंत ढवळा.',
        'Crisp Guanciale' => 'चिकन परता',
        'Fry diced guanciale in skillet over medium heat until crispy and fat is rendered.' => 'पॅनमध्ये कुरकुरीत होईपर्यंत परता.',
        'Whisk Egg & Cheese Mixture' => 'अंडी व चीज मिक्स करा',
        'Whisk egg yolks with grated pecorino romano and black pepper in a bowl.' => 'बाऊलमध्ये अंड्याचा पिवळा भाग, चीज आणि काळी मिरी मिक्स करा.',
        'Emulsify Pasta Sauce' => 'पास्ता सॉस मिक्स करा',
        'Toss hot spaghetti into skillet, remove from heat, quickly stir in egg mixture to create creamy sauce.' => 'गरम पास्तामध्ये अंड्याचे मिश्रण घालून क्रीमी सॉस बनवा.',
        'Marinate & Grill Chicken' => 'चिकन मॅरीनेट करा',
        'Marinate chicken in yogurt and spices for 2 hours, then sear until charred.' => 'दही आणि मसाल्यांमध्ये मॅरीनेट करून ग्रिल करा.',
        'Simmer Makhani Gravy' => 'मखनी ग्रेव्ही शिजवा',
        'Cook tomato puree with butter and spices for 15 minutes until oil separates.' => 'टोमॅटो प्युरी बटरसोबत १५ मिनिटे शिजवा.',
        'Combine & Finish with Cream' => 'क्रीम घालून पूर्ण करा',
        'Add seared chicken to gravy, stir in heavy cream and crushed kasuri methi.' => 'ग्रेव्हीमध्ये चिकन, क्रीम आणि कसुरी मेथी मिक्स करा.',
        'Blend Cashew Tomato Gravy' => 'काजू टोमॅटो पेस्ट बनवा',
        'Blend soaked cashews with tomatoes into smooth puree. Sauté in butter with spices.' => 'काजू आणि टोमॅटोची पेस्ट बनवून बटरमध्ये परता.',
        'Simmer Paneer Cubes' => 'पनीर शिजवा',
        'Add fresh paneer cubes into simmering gravy and cook on low heat for 5 minutes.' => 'ग्रेव्हीमध्ये पनीरचे तुकडे घालून ५ मिनिटे शिजवा.',
        'Garnish with Cream' => 'क्रीमने सजवा',
        'Drizzle heavy cream and sprinkle kasuri methi before serving with garlic naan.' => 'वर क्रीम आणि कसुरी मेथी घालून सर्व्ह करा.',
        'Marinate Biryani Chicken' => 'बिर्याणी चिकन मॅरीनेट करा',
        'Marinate chicken with yogurt, ginger garlic paste, green chilies, mint, and whole biryani spices.' => 'दही, आले-लसूण पेस्ट आणि मसाल्यांसह चिकन मॅरीनेट करा.',
        'Parboil Basmati Rice' => 'बासमती भात उकळवा',
        'Boil basmati rice with cardamom and cloves until 70% cooked.' => 'वेलची आणि लवंग टाकून भात ७०% उकळवा.',
        'Dum Layer & Steam Cook' => 'दम लावून शिजवा',
        'Layer marinated chicken and rice in handi, sprinkle saffron ghee, seal lid and dum cook for 25 minutes.' => 'हंडीत चिकन आणि भाताचे थर लावून २५ मिनिटे दम द्या.',
        'Pressure Cook Chickpeas' => 'चणे उकळवा',
        'Pressure cook soaked chickpeas with tea bag and bay leaf until buttery soft.' => 'कुकरमध्ये चणे मऊ होईपर्यंत उकळा.',
        'Simmer Spicy Chole Gravy' => 'छोले ग्रेव्ही शिजवा',
        'Sauté onions, ginger, tomato paste, chole masala, and simmer cooked chickpeas.' => 'कांदा आणि मसाल्यासोबत चणे मंद आचेवर शिजवा.',
        'Fry Puffed Bhaturas' => 'भटुरे तळा',
        'Knead fermented dough, roll discs and deep fry in hot oil until puffed golden.' => 'मैदा मळून गरम तेलात भटुरे तळा.',
        'Prepare Spiced Potato Filling' => 'बटाटा भाजी बनवा',
        'Temper mustard seeds, curry leaves, onions, turmeric, and mix with mashed potatoes.' => 'मोहरी, कढीपत्ता आणि मसाल्यांसह बटाटा भाजी बनवा.',
        'Spread Crisp Dosa Crepe' => 'डोसा पसरवा',
        'Ladle fermented batter onto hot tawa, spread thinly into circle and drizzle oil.' => 'तव्यावर पीठ पसरवून तेल सोडा.',
        'Stuff & Roll Dosa' => 'डोसा रोल करा',
        'Place potato mash in center, fold golden crispy dosa and serve with sambar.' => 'मधात भाजी ठेवून डोसा रोल करा.',
        'Prep Fresh Ingredients' => 'साहित्य तयार करा',
        'Wash, chop, and marinate fresh ingredients with seasonings.' => 'साहित्य धुवून बारीक चिरा व मसाले लावा.',
        'Sauté & Cook Medium Heat' => 'मंद आचेवर शिजवा',
        'Cook ingredients in skillet until fragrant, golden, and cooked through.' => 'साहित्य पॅनमध्ये सुवासिक होईपर्यंत शिजवा.',
        'Plate & Serve Hot' => 'गरमागरम सर्व्ह करा',
        'Transfer to serving plate, garnish with herbs and serve fresh!' => 'प्लेटमध्ये काढून गरमागरम सर्व्ह करा!',
